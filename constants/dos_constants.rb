...
REUSED_SPECIAL_OBJECT_INFO = {
  ...
  0x06 => {init_code: 0x0222B8E0, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # area titles. however, palette is at the create code. TODO
  0x09 => {init_code: 0x0222BD04, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # chair
  0x11 => {init_code:         -1, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # 
  ...
  0x36 => {init_code:         -1, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # 
