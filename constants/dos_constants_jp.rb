...
MAP_SECRET_ROOM_DATA_START_OFFSET = 0x02079D40
MAP_DRAW_X_OFFSET_LOCATION = 0x02024D94
MAP_DRAW_Y_OFFSET_LOCATION = 0x02024D64
...
ABYSS_MAP_DRAW_X_OFFSET_LOCATION = 0x02024D9C
ABYSS_MAP_DRAW_Y_OFFSET_LOCATION = 0x02024D6C

WARP_ROOM_LIST_START = 0x0222B518
WARP_ROOM_ICON_POS_LIST_START = 0x0209A098

SECTOR_MUSIC_LIST_START_OFFSET = 0x0209A544

ASSET_LIST_START = 0x0208CC6C
ASSET_LIST_END = 0x02099FD3
...
NEW_GAME_STARTING_X_POS_OFFSET = 0x0222CF78
NEW_GAME_STARTING_Y_POS_OFFSET = 0x0222CF7C

TRANSITION_ROOM_LIST_POINTER_HARDCODED_LOCATIONS = [0x02006FB0, 0x02025D9C]
...
NEW_OVERLAY_FREE_SPACE_START = 0x02307960
NEW_OVERLAY_FREE_SPACE_MAX_SIZE = 0x10000
ASSET_MEMORY_START_HARDCODED_LOCATION = 0x02060230
...
WEAPON_SYNTH_CHAIN_LIST_START = 0x0209CBCC

SHOP_ITEM_POOL_LIST = 0x02037308
SHOP_ITEM_POOL_LENGTH_HARDCODED_LOCATIONS = [0x02037198, 0x020371C0, 0x020371E8]
SHOP_ITEM_POOL_REQUIRED_EVENT_FLAG_HARDCODED_LOCATIONS = [nil, 0x020371B0, 0x020371D8]

MAGIC_SEAL_LIST_START = 0x0222E28C
MAGIC_SEAL_FOR_BOSS_LIST_START = 0x0222E340
