...
OTHER_SPRITES = [
  ...
  # Note: 0x0822AEE4 is a sprite pointer that may have been been an old sprite for Soma in an earlier version. But it's not used in the final game and the animations in it look very buggy.
