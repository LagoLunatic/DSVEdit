...
ENEMY_IDS = (0x00..0x9A)
COMMON_ENEMY_IDS = (0x00..0x80)
BOSS_IDS = (0x81..0x9A)
FINAL_BOSS_IDS = (0x99..0x9A)
RANDOMIZABLE_BOSS_IDS = BOSS_IDS.to_a - FINAL_BOSS_IDS.to_a
...
FAKE_PICKUP_GLOBAL_IDS = [0x60, 0xA9, 0xE3, 0x109, 0x126, 0x150]
...
NEW_OVERLAY_ID = 119
NEW_OVERLAY_FREE_SPACE_START = 0x023BD100
NEW_OVERLAY_FREE_SPACE_END = 0x023DFFFF
NEW_OVERLAY_FREE_SPACE_SIZE = 0x22F00
