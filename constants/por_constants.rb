...
OTHER_SPRITES = [
  ...
  {pointer: 0x020592E8, desc: "Main menu shared parts", overlay: 25},
  {pointer: 0x022E055C, desc: "Data menu", overlay: 38},
  {pointer: 0x022DA15C, desc: "Select data menu", overlay: 25},
  {pointer: 0x022DAAE0, desc: "Name entry menu", overlay: 25},
  {pointer: 0x022DBB10, desc: "Emblem draw screen", overlay: 25},
  ...
  {pointer: 0x02046BAC, desc: "Shop main menu"},
  {pointer: 0x020466F4, desc: "Shop buy/sell menu"},
  ...
  {pointer: 0x022E0464, desc: "Co-op mode retry/complete", overlay: 32},
  {pointer: 0x022E0848, desc: "Select connection mode", overlay: 33},
  #{pointer: 0x022E0AB4, desc: "Co-op mode retry/complete (duplicate)", overlay: 33},
  {pointer: 0x022E1964, desc: "Co-op mode settings", overlay: 33},
  {pointer: 0x022E1974, desc: "Co-op mode ???", overlay: 33},
  #{pointer: 0x022E1964, desc: "unk33", overlay: 33},
  #{pointer: 0x022E1F9C, desc: "unk33", overlay: 33},
  {pointer: 0x022E4C20, desc: "Co-op mode select player", overlay: 33},
  {pointer: 0x022E0A68, desc: "Wi-fi menu", overlay: 34},
  {pointer: 0x022E0D5C, desc: "Wi-fi select", overlay: 34},
  {pointer: 0x022E138C, desc: "Shop mode select character", overlay: 34},
  #{pointer: 0x022E139C, desc: "Co-op mode ??? (duplicate)", overlay: 34},
  #{pointer: 0x022E19D0, desc: "Co-op mode ??? (duplicate 2)", overlay: 34},
  {pointer: 0x022E0650, desc: "Nintendo WFC options", overlay: 36},
  {pointer: 0x022E25EC, desc: "Friend code menu", overlay: 36},
  {pointer: 0x022E0E80, desc: "Friend code list", overlay: 36},
  {pointer: 0x022E1884, desc: "Friend code enter menu", overlay: 36},
  #{pointer: 0x022E22DC, desc: "Friend code enter menu (duplicate)", overlay: 36},
  {pointer: 0x022E07B4, desc: "Boss rush select course", overlay: 32},
  ...
  # Game ends
  {pointer: 0x022E04F0, desc: "Game over", overlay: 35},
  {pointer: 0x022E04E0, desc: "Game over (Sisters Mode)", overlay: 35},
  {pointer: 0x022E0EB4, desc: "Credits", overlay: 37},
  {pointer: 0x022E11DC, desc: "Credits portraits", overlay: 37},
  {pointer: 0x022E0D90, desc: "Credits sprites", overlay: 37},
  ...
  # Boss extras
  {desc: "Behemoth/Legion/Werewolf/Mummy Man death flame", sprite: 0x0213DB24, gfx_wrapper: 0x020BF8CC, palette: 0x022B7660},
  {pointer: 0x022D7CBC, desc: "Brauner inside mirror portrait", overlay: 55},
  {pointer: 0x022D7C98, desc: "Brauner curse beast", overlay: 55},
  {pointer: 0x022D7CB0, desc: "Brauner poison beast", overlay: 55},
...
STRING_DATABASE_ALLOWABLE_END_OFFSET = nil
STRING_DATABASE_ORIGINAL_END_OFFSET_FOR_OVERLAY = {
  1 => 0x0222C835,
  2 => 0x0222B34C,
}
STRING_DATABASE_ALLOWABLE_END_OFFSET_FOR_OVERLAY = STRING_DATABASE_ORIGINAL_END_OFFSET_FOR_OVERLAY.dup
TEXT_COLOR_NAMES = {
  0x00 => "TRANSPARENT",
  0x01 => "WHITE",
  0x02 => "BLACK",
...
PLAYER_BITFIELD_ATTRIBUTES = {
  ...
  "Damage types" => [
    ...
    "Unknown 16",
    "Unknown 17",
    "Take less damage & Reflect projectiles",
    "Can be hit",
    "Unknown 20",
    "Unknown 21",
    "Unknown 22",
    "Unknown 23",
    "Knuckles",
    "Is a weapon (activates switches)",
    "Is a subweapon",
    "Is a spell",
    "Cures vampirism & kills undead",
    "Is a dual crush",
