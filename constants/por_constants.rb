...
REUSED_ENEMY_INFO = {
   #17 => {init_code: 0x0222D5DC, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # wight -> zombie
   84 => {init_code:        nil, gfx_sheet_ptr_index: 0, palette_offset: 1, palette_list_ptr_index: 0}, # ghoul and zombie
   94 => {init_code: 0x02259EE4, gfx_sheet_ptr_index: 0, palette_offset: 0, palette_list_ptr_index: 0}, # tanjelly -> slime
