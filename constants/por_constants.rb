...
FAKE_PICKUP_GLOBAL_IDS = [0x60, 0xA9, 0xE3, 0x109, 0x126, 0x150, 0x1A1] + [0x08, 0x09] + [0x12C]
...
NEW_OVERLAY_ID = 119
NEW_OVERLAY_FREE_SPACE_START = 0x023C0000
NEW_OVERLAY_FREE_SPACE_END = 0x023DFFFF
NEW_OVERLAY_FREE_SPACE_SIZE = 0x20000
