...
OVERLAY_FILE_FOR_ENEMY_AI = {
  ...
  0x13 => 0x48, # andras
  0x15 => 0x4C, # golem
  0x21 => 0x2C, # great armor
  0x22 => 0x30, # catoblepas
  0x25 => 0x44, # dragon zombie
  0x2A => 0x45, # sand worm
  0x2C => 0x3E, # amphisbaena
  0x2D => 0x36, # elgiza
  0x45 => 0x2D, # treant
  0x4E => 0x2F, # flame demon
  0x51 => 0x2E, # malphas
  0x52 => 0x2C, # final guard
  0x55 => 0x47, # ruler's sword
  0x5A => 0x4D, # amalaric sniper
  0x5C => 0x30, # gorgon
  0x64 => 0x49, # alura une
  0x72 => 0x45, # poison worm
  0x78 => 0x2D, # iron golem
  0x7A => 0x2F, # demon
  0x7D => 0x4B, # alastor
  0x81 => 0x2B, # balore
  0x82 => 0x32, # gergoth
  ...
  0x84 => 0x43, # aguni
  0x85 => 0x33, # abaddon
  0x87 => 0x46, # fake trevor
  0x88 => 0x46, # fake grant
  0x89 => 0x46, # fake sypha
  0x8A => 0x3A, # dullahan
  0x8B => 0x35, # behemoth
  0x8C => 0x38, # keremet
  0x8D => 0x4A, # astarte
  ...
  0x8F => 0x3B, # dagon
  0x90 => 0x40, # death
  0x91 => 0x3F, # stella/loretta
  0x92 => 0x3F, # stella/loretta
  0x93 => 0x37, # brauner
  0x94 => 0x3C, # the creature
  0x95 => 0x39, # werewolf
  0x96 => 0x3D, # medusa
  0x97 => 0x42, # mummy man
  0x98 => 0x19, # whip's memory
  0x99 => 0x40, # dracula
  0x9A => 0x41, # true dracula
}
REUSED_ENEMY_INFO = {
