...
SECTOR_INDEX_TO_SECTOR_NAME = {
   0 => {
      ...
      4 => "The Wailing Way & Shrine of the Apostates A",
      5 => "The Wailing Way & Shrine of the Apostates B",
     ...
     14 => "Chapel of Dissonance & Sky Walkway A",
     15 => "Chapel of Dissonance & Sky Walkway B",
     16 => "Clock Tower A",
     17 => "Clock Tower B",
