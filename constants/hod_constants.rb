...
BOSS_IDS = [] # TODO
COMMON_ENEMY_IDS = ENEMY_IDS - BOSS_IDS

BOSS_DOOR_SUBTYPE = 0x06
BOSS_ID_TO_BOSS_INDEX = {
  0x09 => 0x01, # Giant Bat
  0x1F => 0x02, # Skull Knight
  0x11 => 0x03, # Living Armor
  0x1E => 0x04, # Golem
  0x28 => 0x05, # Minotaur
  0x2E => 0x06, # Devil
  0x36 => 0x07, # Giant Merman
  0x37 => 0x08, # Max Slimer
  0x42 => 0x09, # Peeping Big
  0x43 => 0x0A, # Legion (saint)
  0x44 => 0x0B, # Shadow
  0x53 => 0x0C, # Minotaur Lv2
  0x54 => 0x0D, # Legion (corpse)
  0x55 => 0x0E, # Talos
  0x56 => 0x0F, # Death
  0x60 => 0x10, # Cyclops
  0x77 => 0x11, # Talos (chase)
  0x49 => 0x12, # Pazuzu
}
